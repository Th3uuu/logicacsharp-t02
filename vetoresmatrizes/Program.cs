//Declaração de doi vetores
int[] numeros = { 7, 2, 3, 34, 5 }; //Valor de inteiros
string [] nomes = { "Ana", "João", "Maria", "Carlos" }; //Valor de strings
...
// Ordenar antes ea pesquisa binária
Array.Sort(numeros);
...
{
    Console.WriteLine($"Pesquisa Binária: valo {valorProcurado} não encontrado.");
}
